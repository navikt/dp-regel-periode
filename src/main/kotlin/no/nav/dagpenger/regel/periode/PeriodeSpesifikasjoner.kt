...
val ordinærSiste12Måneder104Uker =
    Spesifikasjon<Fakta>(
...
val ordinærSiste36Måneder104Uker =
    Spesifikasjon<Fakta>(
...
val ordinærSiste12MånederMedFangstOgFiske104Uker =
    Spesifikasjon<Fakta>(
        ...
        implementasjon = {
            when {
                fangstOgFiskeErIkkeAvviklet() && inntektSiste12inkludertFangstOgFiske >= (grunnbeløp.times(BigDecimal(2))) ->
                    Evaluering.ja(
                        "104",
                    )
                else -> Evaluering.nei("0")
...
val ordinærSiste36MånederMedFangstOgFiske104Uker =
    Spesifikasjon<Fakta>(
...
val ordinærSiste36Måneder52Uker =
    Spesifikasjon<Fakta>(
...
val ordinærSiste12MånederMedFangstOgFiske52Uker =
    Spesifikasjon<Fakta>(
        ...
        implementasjon = {
            when {
                fangstOgFiskeErIkkeAvviklet() &&
                    inntektSiste12inkludertFangstOgFiske < (grunnbeløp.times(BigDecimal(2))) -> Evaluering.ja("52")
                else -> Evaluering.nei("0")
            }
        },
    )

val ordinærSiste36MånederMedFangstOgFiske52Uker =
    Spesifikasjon<Fakta>(
        beskrivelse =
            """
        |§ 4-15 Antall stønadsuker (stønadsperiode), 
        |med fangst og fisk, siste 36 mnd, 52 uker
            """.trimMargin(),
...
val periode: Spesifikasjon<Fakta> =
    Spesifikasjon(
